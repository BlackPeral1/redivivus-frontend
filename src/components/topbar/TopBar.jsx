        ...
        <nav className="navbar mb-4 font-color">
          <div id='tcontainer' className="container container-topbar">
            <div className="top-logo d-flex justify-content-between">
              <a href="#" onClick={toggleClass} className="navbar-brand" id="sidebar-toggle"><FontAwesomeIcon icon="fas fa-bars" /></a>
            </div>
            <form className="d-flex search-box">
              <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search" />
              <button className="btn font-color topbar-hover tcontainerbtn" type="submit"><i className="fas fa-search"></i></button>
            </form>
